								...
								<c:choose>
									<c:when test="${favorites.dongCode eq dongCode}">
										<tr style="--bs-table-accent-bg: var(--bs-table-hover-bg); color: var(--bs-table-hover-color);">
											<td>
												<b><a href="${root}/house/showMap?id=${id}&dongCode=${favorites.dongCode}&page=${currentPage}">${favorites.sidoName}&nbsp;${favorites.gugunName}&nbsp;${favorites.dongName}</a></b>
											</td>
										</tr>
									</c:when>
									<c:otherwise>
										<tr>
											<td>
												<a href="${root}/house/showMap?id=${id}&dongCode=${favorites.dongCode}&page=${currentPage}">${favorites.sidoName}&nbsp;${favorites.gugunName}&nbsp;${favorites.dongName}</a>
											</td>
										</tr>
									</c:otherwise>
								</c:choose>
					...
					<ul class="pagination justify-content-center">
						<c:if test="${currentPage != 1}">
							<li class="page-item"><a class="page-link"
								href="${root}/house/favorite?id=${id}&page=${currentPage - 1}">&lt;</a></li>
						</c:if>
							...
							<c:choose>
								<c:when test="${currentPage eq i}">
									<li class="page-item active"><a class="page-link"
										href="${root}/house/favorite?id=${id}&page=${i}">${i}</a></li>
								</c:when>
								<c:otherwise>
									<li class="page-item"><a class="page-link"
										href="${root}/house/favorite?id=${id}&page=${i}">${i}</a></li>
