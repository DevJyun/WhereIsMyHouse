...
<body class="d-flex flex-column">
    ...
    <div class="container">
        ...
        <form id="form-findByDong" action="${root}/house/dongFind">
					...
					<div style="display: flex; justify-content : center;">
						...
						<c:choose>
							<c:when test="${!empty isFav}">
								<form action="${root}/removeFavorite">
					...
					<table class="table table-hover" style="text-align: center; vertical-align: middle;">
						...
						<tbody>
							...
							<c:forEach items='${houseList}' var='house'>
								<tr>
									<td><b><a href="${root}/house/showHouseDetail?no=${house.no}">${house.aptName}</a></b></td>
			...
			<ul class="pagination justify-content-center">
				<c:if test="${currentPage != 1}">
					<li class="page-item"><a class="page-link"
						href="${root}/house/dongFind?dongCode=${dongCode}&page=1">&lt;&lt;</a></li>
				</c:if>
				<c:if test="${currentPage != 1}">
					<li class="page-item"><a class="page-link"
						href="${root}/house/dongFind?dongCode=${dongCode}&page=${currentPage - 1}">&lt;</a></li>
				</c:if>
					...
					<c:choose>
						<c:when test="${currentPage eq i}">
							<li class="page-item active"><a class="page-link"
								href="${root}/house/dongFind?dongCode=${dongCode}&page=${i}">${i}</a></li>
						</c:when>
						<c:otherwise>
							<li class="page-item"><a class="page-link"
								href="${root}/house/dongFind?dongCode=${dongCode}&page=${i}">${i}</a></li>
				...
				<c:if test="${currentPage != noOfPages}">
					<li class="page-item"><a class="page-link"
						href="${root}/house/dongFind?dongCode=${dongCode}&page=${noOfPages}">&gt;&gt;</a></li>
				</c:if>
			</ul>
		</div>
