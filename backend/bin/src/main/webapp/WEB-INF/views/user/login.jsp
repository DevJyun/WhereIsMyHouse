          ...
          <div class="bg-light rounded-3 py-5 px-4 px-md-5 mb-5">
            ...
            <div class="row gx-5 justify-content-center">
              <div class="col-lg-8 col-xl-6">
                ...
                <!-- to get an API token!-->
                <form id="loginForm" method="POST" data-sb-form-api-token="API_TOKEN">
                  <!-- Id address input-->
...
        			<input type="hidden" id="password_rsa" name="password_rsa">
      ...
      <div class="container px-5">
        <div class="row align-items-center justify-content-between flex-column flex-sm-row">
          ...
          <div class="col-auto">
            ...
            <span class="text-white mx-1">&middot;</span>
            <a class="link-light small" href="#!"><%=request.getContextPath()%></a>
          </div>
        </div>
      </div>
    </footer>
    ...
    <!-- Core theme JS-->
    <%-- <script src="<%=request.getContextPath()%>/resources/static/js/scripts.js"></script> --%>
